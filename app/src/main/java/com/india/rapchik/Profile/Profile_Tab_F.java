package com.india.rapchik.Profile;
...
import com.india.rapchik.Settings.Setting_F;
...
import com.india.rapchik.Following.Following_F;
...
import com.india.rapchik.Profile.Liked_Videos.Liked_Video_F;
import com.india.rapchik.Profile.UserVideos.UserVideo_F;
import com.india.rapchik.R;
import com.india.rapchik.See_Full_Image_F;
import com.india.rapchik.SimpleClasses.Functions;
import com.india.rapchik.SimpleClasses.Variables;
import com.india.rapchik.Video_Recording.GalleryVideos.GalleryVideos_A;
...
public class Profile_Tab_F extends RootFragment implements View.OnClickListener  {
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_my_video_white));
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        ...
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_my_video_white));
                        break;

                    case 1:
                        create_popup_layout.clearAnimation();
                        create_popup_layout.setVisibility(View.GONE);
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_liked_video_white));
                        break;
                }
                tab.setCustomView(v);
            }
