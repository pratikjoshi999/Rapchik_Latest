...
import com.india.rapchik.Chat.Chat_Activity;
import com.india.rapchik.Notifications.Notification_F;
...
import com.india.rapchik.Accounts.Login_A;
import com.india.rapchik.Discover.Discover_F;
import com.india.rapchik.Home.Home_F;
import com.india.rapchik.Main_Menu.RelateToFragment_OnBack.OnBackPressListener;
import com.india.rapchik.Main_Menu.RelateToFragment_OnBack.RootFragment;
import com.india.rapchik.Profile.Profile_Tab_F;
...
import com.india.rapchik.Video_Recording.Video_Recoder_A;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_white_n));
        title1.setText("Home");
        ...
        imageView2.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_gray_n));
        ...
        imageView4.setImageDrawable(getResources().getDrawable(R.drawable.ic_notification_gray_n));
        ...
        imageView5.setImageDrawable(getResources().getDrawable(R.drawable.ic_profile_gray_n));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener(){
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_white_n));
                        title.setTextColor(context.getResources().getColor(R.color.white));
                        break;

                    case 1:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_yellow));
                    ...
                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_notification_yellow));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
                    case 4:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_profile_yellow));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.app_color));
                        break;
                }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_gray_n));
                        title.setTextColor(context.getResources().getColor(R.color.darkgray));
                        break;
                    case 1:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_discover_gray_n));
                        title.setTextColor(context.getResources().getColor(R.color.darkgray));
                        break;

                    case 3:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_notification_gray_n));
                        title.setTextColor(context.getResources().getColor(R.color.darkgray));
                        break;
                    case 4:
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_profile_gray_n));
                        title.setTextColor(context.getResources().getColor(R.color.darkgray));
                        break;
                }
                tab.setCustomView(v);
    ...
    public void OnHome_Click (){
        ...
        image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_add_video));
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getActivity().getWindow().setNavigationBarColor(ContextCompat.getColor(context, R.color.black_bg_color));
        }
    }
